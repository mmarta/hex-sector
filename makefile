...
OBJECTS = uzeboxVideoEngineCore.o uzeboxCore.o uzeboxSoundEngine.o uzeboxSoundEngineCore.o uzeboxVideoEngine.o gfx.o audio.o location.o shot.o player.o virus.o machine.o game.o title.o main.o
